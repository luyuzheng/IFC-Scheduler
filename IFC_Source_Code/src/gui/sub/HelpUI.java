...
public class HelpUI extends JDialog implements KeyListener, ActionListener {
	...
	private String helpText =
		...
		+ " \t\t2.2.1 Setting up a new day	 \n"
		+ " \t\t2.2.2 Adding practitioners	 \n"
		+ " \t\t2.2.3 Removing practitioners from the day's roster	 \n"
		+ " \t\t2.2.4 Scheduling appointments	 \n"
		+ " \t\t2.2.5 Adding or editing an appointment note	 \n"
		+ " \t\t2.2.6 Removing scheduled appointments	 \n"
		+ " \t\t2.2.7 Viewing the wait list	 \n"
		+ " \t\t2.2.8 Adding a patient to the wait list	 \n"
		+ " \t\t2.2.9 Removing a patient from the wait list	 \n"
		+ " \t\t2.2.10 Scheduling a patient from the wait list	 \n"
		+ " \t\t2.2.11 Editing patients	 \n"
		+ " \t\t2.2.12 Printing the current day view	 \n"
		+ " \t\t2.2.13 Printing the current month view	 \n"
		+ " \t\t2.2.14 Switching to the month view	 \n"
		+ " \t\t2.2.15 Switching to the day view	 \n"
		+ " \t\t2.2.16 Setting the default hours for a day	 \n"
		+ "\n\n"
		+ " \t\t** 0. INSTALLATION INSTRUCTIONS **	 \n"
		...
		+ " 2) You must enter in two times into this dialog: the start and end time. The start time should come before the end time, and bnoth should be typed in military time (00:00 - 23:59). \n\n"
		...
		+ "\n"
		+ " 2.2.3 Removing a practitioner from a day's roster:	 \n"
		+ "\n"
